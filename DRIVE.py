...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("DRIVE",largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("This is a Driving game in which you dodge the cars to score!",smalltext)
...
# for countdown at the starting of the game... (3..2..1)
...
# Different object display according to the random int passed in the function...
...
# calls the message display function with a Game over text...
def crash():
    message_display("LEARN TO DRIVE!")

# setting the gaming background...
def background():
    gamedisplays.blit(backgroundpic,(0,0))
    gamedisplays.blit(backgroundpic,(0,200))
    gamedisplays.blit(backgroundpic,(0,400))
...
# setting the origin for the player's car...
def car(x,y):
    gamedisplays.blit(carimg,(x,y))
